...
if __name__ == '__main__':
    args = getArgs()
    instance = LocalFaultDetector(args.lfd_id, args.heartbeat_freq, addr=(args.host, int(args.port)))
    instance.init(args.server_id)
    instance.check_server_alive(args.server_id)
